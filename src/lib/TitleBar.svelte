...
<header>
	<div class="drag-region">
		...
		<div class="window-controls">
			<div class="button" on:click={minimize} data-testid="IconMinimize">
				<IconMinimize />
			</div>
			{#if isMaximized}
				<div class="button" on:click={unmaximize} data-testid="IconUnmaximize">
					<IconUnmaximize />
				</div>
			{:else}
				<div class="button" on:click={maximize} data-testid="IconMaximize">
					<IconMaximize />
				</div>
			{/if}
			<div class="button" on:click={close} data-testid="IconClose">
				<IconClose />
			</div>
		</div>
	</div>
